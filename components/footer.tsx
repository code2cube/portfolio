    ...
    <footer className="bg-black text-white p-5 flex flex-col h-20 text-center justify-center items-center gap-1 z-50">
      <div className="flex gap-3">
        <Link href="https://github.com/code2cube/">
          <i className="bi bi-github hover:text-red-700 transition ease-in duration-200"></i>
        </Link>
        <Link href="https://www.instagram.com/live2cube">
          <i className="bi bi-instagram hover:text-red-700 transition ease-in duration-200"></i>
        </Link>
        <Link href="https://www.linkedin.com/in/samuel-sharivker/">
          <i className="bi bi-linkedin hover:text-red-700 transition ease-in duration-200"></i>
        </Link>
      </div>
